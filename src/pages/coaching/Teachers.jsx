...
const teacherStats = [
  { icon: 'group', label: 'Total Teachers', value: '24', change: '+3', helper: 'This month', tone: 'blue' },
  { icon: 'school', label: 'Active Courses', value: '8', change: '+2', helper: 'Assigned', tone: 'emerald' },
  { icon: 'check_circle', label: 'Verified', value: '22', change: '+2', helper: 'Approved', tone: 'rose' },
  { icon: 'pending', label: 'Pending', value: '2', change: '-', helper: 'Approval', tone: 'amber' },
  { icon: 'star', label: 'Avg Rating', value: '4.6', change: '+0.1', helper: 'Reviews', tone: 'purple' },
  { icon: 'event', label: 'Classes Today', value: '12', change: '+3', helper: 'Scheduled', tone: 'green' },
];
...
export default function CoachingTeachers() {
  ...
  return (
    ...
    >
      ...
      <SectionCard title="All Teachers" description="Manage faculty and instructors">
